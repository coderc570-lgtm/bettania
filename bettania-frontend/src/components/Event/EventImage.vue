<template>
    <div>
        <div class="flex-col text-center justify-center mb-5">
            <h2>Event Details</h2>
            <p>Engage your audience right from the beginning with a captivating event description that showcases the event’s purpose and energy.</p>
        </div>
